...
After applying the configuration, **`Metal LB`** will assign external IP addresses from the defined pool to services of type LoadBalancer, like **`NGINX`** or **`Traefik`**.
