...
# Raspberry Pi 4B with 4GB RAM      - 2nd case          - eth0 MAC ID d8:3a:dd:02:a3:d7 | wlan0 MAC ID d8:3a:dd:02:a3:d8 - gateway
# Orange Pi Zero 2W with 4GB RAM    - standalone case   - eth0 MAC ID 36:74:d6:15:64:8c | wlan0 MAC ID 84:49:C3:5C:0C:76 - hedgeway
# Asus ROG Flow Z13                 - WSL               - wlan0 MAC ID 00:15:5d:85:35:cb - ansible
# Raspberry Pi 4B with 4GB RAM      - 3rd case          - eth0 MAC ID e4:5f:01:f5:c1:ae - blueberry-master
# Raspberry Pi 4B with 8GB RAM      - 4th case          - eth0 MAC ID e4:5f:01:df:31:a2 - strawberry-master
# Raspberry Pi 4B with 8GB RAM      - 5th case          - eth0 MAC ID dc:a6:32:73:69:c9 - blackberry-master
# Raspberry Pi 5 with 8GB RAM       - 6th case          - eth0 MAC ID d8:3a:dd:b6:12:77 - cranberry-worker
# Raspberry Pi 3B+ with 1GB RAM     - 1st case          - eth0 MAC ID b8:27:eb:d2:40:87 - raspberry-worker
# Orange Pi 5 Ultra with 16GB RAM   - 7th case          - eth0 MAC ID c0:74:2b:fc:57:d8 - lemon-worker
# Orange Pi 5 Ultra with 16GB RAM   - 8th case          - eth0 MAC ID c0:74:2b:fc:57:9b - clementine-worker
# Orange Pi 5 Ultra with 16GB RAM   - 9th case          - eth0 MAC ID c0:74:2b:fc:57:f1 - grapefruit-worker
# Orange Pi 5 with 16GB RAM         - 10th case         - eth0 MAC ID not stable wlan0 MAC ID not stable - orange-worker
# Orange Pi 5 with 16GB RAM         - 11th case         - eth0 MAC ID not stable wlan0 MAC ID not stable - mandarine-worker
...
# DNS Configuration
server=1.1.1.1                  # Primary DNS server
server=8.8.8.8                  # Secondary DNS server
...
dhcp-host=36:74:d6:15:64:8c,10.0.0.2   # hedgeway
dhcp-host=00:15:5d:85:35:cb,10.0.0.3   # ansible
...
dhcp-host=c0:74:2b:fc:57:d8,10.0.0.17  # lemon-worker
dhcp-host=c0:74:2b:fc:57:9b,10.0.0.18  # clementine-worker
dhcp-host=c0:74:2b:fc:57:f1,10.0.0.19  # grapefruit-worker

# Hostname-based assignments for Orange Pis
dhcp-host=orange-worker,10.0.0.15      # orange-worker
dhcp-host=mandarine-worker,10.0.0.16   # mandarine-worker

# Additional DHCP hosts (future addition)
dhcp-host=8C:90:2D:9D:32:8F,10.0.0.4   # Ethernet Switch
